...
class ScoreRecord(UpsertRecord):
    ...
    visiting_team_id: int | None
    home_abbrev: str | None
    visiting_abbrev: str | None
    home_score: int | None
    visiting_score: int | None
    home_sog: int | None
    visiting_sog: int | None


@dataclass(frozen=True)
class PlayerGameRecord(UpsertRecord):
    game_id: int
    player_id: int
    player_name: str
    team_id: int
